<aside class="absolute left-0 top-0 z-10 flex h-screen w-72 flex-col overflow-y-hidden bg-gray-800 duration-300 ease-linear dark:bg-gray-800 lg:static lg:translate-x-0">
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5 lg:py-6">
        ...
        <button class="block rounded-full duration-150 ease-linear hover:bg-graydark p-3 text-white lg:hidden">
            <svg
                class="fill-current"
                width="20"
                height="18"
        ...
        <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
            ...
            <div">
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium text-gray-400 hover:text-gray-300 dark:hover:text-gray-300 duration-300 ease-in-out hover:bg-gray-700 dark:hover:bg-gray-700"
                            href="#">
                            <svg
                                class="fill-current"
                                width="18"
                    ...
                    <!-- Menu Item Pesansan Masuk End -->

                    <!-- Menu Item Laporan Penjualan Start -->
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium text-gray-400 hover:text-gray-300 dark:hover:text-gray-300 duration-300 ease-in-out hover:bg-gray-700 dark:hover:bg-gray-700"
                            href="#">
                            <svg
                    ...
                    <!-- Menu Item Laporan Penjualan End -->

                    <!-- Menu Item User Start -->
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium text-gray-400 hover:text-gray-300 dark:hover:text-gray-300 duration-300 ease-in-out hover:bg-gray-700 dark:hover:bg-gray-700"
                            href="#">
                            <svg
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-md px-3 py-2 font-medium text-gray-400 hover:text-gray-300 dark:hover:text-gray-300 duration-300 ease-in-out hover:bg-gray-700 dark:hover:bg-gray-700"
                            href="#">
                            <svg
                                class="fill-current"
                                width="22"
